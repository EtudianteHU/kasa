...
const About = () => {
  ...
  return (
    <Section>
      ...
      > la gestion de l'état collapse (is open/is not open) ainsi que le toggle doivent être gérés dans le composant et pas dans la page. La fonction toggle et le state isOpen devraient donc être à l'intérieur du composant et non dans la page. Il ne faut donc pas passer ces deux éléments en props.
