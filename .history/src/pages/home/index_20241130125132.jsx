...
const CardContainer = styled.div`
  flex: 0 0 calc(33% - 30px);  // Cards take up 33% width minus 30px to account for the gap
  margin: 56px 15px; // Margin for spacing between the cards
  min-width: 220px;  // Min-width slightly reduced
